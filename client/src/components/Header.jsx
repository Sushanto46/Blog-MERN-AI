    ...
    return (
        <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
            <div className='mt-20 mb-8 flex flex-col items-center text-center'>
                ...
                <p className='my-6 sm:my-8 max-w-2xl text-gray-500 max-sm:text-xs'>
                ...
                <form onSubmit={onSubmitHandler} className='flex justify-between max-w-lg w-full max-sm:scale-75 border border-gray-300 bg-white rounded overflow-hidden'>
                    <input
                        ref={inputRef}
